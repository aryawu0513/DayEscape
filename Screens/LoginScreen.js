...
export default function LoginScreen({ auth, signedInProps }) {
  ...
  function checkEmailVerification() {
    if (auth.currentUser) {
      ...
      if (auth.currentUser.emailVerified) {
        console.log(`checkEmailVerification: setSignedInUser for ${auth.currentUser.email}`);
        signedInProps.signInUser(auth.currentUser.email);
        setErrorMsg('');
      } else {
